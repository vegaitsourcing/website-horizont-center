...
export function LongButton ({ value, type, onClick, direction, className = "" }) {
	const buttonClassName = [styles.button, type === "border" ? styles.border : styles.filled, className].join(" ");
	return (
