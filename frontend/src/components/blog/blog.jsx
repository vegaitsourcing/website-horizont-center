...
export const Blog = () => {
  ...
  const BLOGS_MOCK = [
    {
      ...
      description:
        "Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst",
    },
    {
      id: 2,
      title: "Blog2",
      ...
      description:
        "Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.Ovo je random tekst.",
    },
    {
      id: 2,
      title: "Blog2",
  ...
  const maximumNumOfCards = 9;
  const numberOfPages = Math.ceil(BLOGS_MOCK.length / maximumNumOfCards);
  ...
  return (
    <>
      ...
      <div className={styles.blogFooter}>
        <CardPagination pageNum={pageNum} numberOfPages={numberOfPages} />
      </div>
    </>
  );
};
