        ...
        <section className={styles.singleBlogMain}>
          <article className={styles.singleBlogMainArticle}>
            ...
            <p className={styles.p1}>
              Eget et id at cras enim enim nunc pellentesque. Quam sit mi odio amet, volutpat malesuada eros
              pellentesque ut. Enim egestas sollicitudin egestas aliquet interdum a. Vestibulum posuere nulla diam ac
              maecenas etiam varius et sociis. Praesent a lacus ipsum cras at justo. Morbi donec porttitor et amet
              tellus. Id feugiat sit pretium ullamcorper et lectus vitae diam iaculis. Magna ultrices fermentum tempus
              accumsan. Lorem nisi, dignissim turpis pellentesque laoreet. Nibh at id id a dictumst sed. Maecenas
              feugiat blandit ut massa nisl, posuere magnis. Egestas facilisis vitae cras lobortis semper cursus ante
              habitasse. Odio et ut id molestie sem. Ut mi ac etiam egestas in vulputate eget non ante. Felis, ut sed
              tortor id diam amet dolor. Metus enim egestas semper enim bibendum sem morbi. Commodo, nulla vel odio
              tellus eu. Aenean justo, turpis turpis sagittis nec, iaculis cursus nec. Hac orci sed scelerisque rutrum
              maecenas pellentesque. Sed felis in laoreet nulla gravida consectetur ut sed lectus.
            </p>
          </article>
          <article className={styles.singleBlogMainArticle}>
            <h2 className={styles.h2}>Adipiscing platea aliquet</h2>
            <p className={styles.p1}>
              Felis, ut sed tortor id diam amet dolor. Metus enim egestas semper enim bibendum sem morbi. Commodo, nulla
              vel odio tellus eu. Aenean justo, turpis turpis sagittis nec, iaculis cursus nec. Hac orci sed scelerisque
              rutrum maecenas pellentesque. Sed felis in laoreet nulla gravida consectetur ut sed lectus.
            </p>
            <img src="/images/singleBlogMain.png" alt="" />
          </article>
          <article className={styles.singleBlogMainArticle}>
            <h2 className={styles.h2}>Eleifend</h2>
            <p className={styles.p1}>
              ...
              metus. Nisi, magna cras sed aliquam rhoncus. Nunc consequat, morbi platea eu dictum adipiscing nulla
              tincidunt. Eu imperdiet id amet, nunc et orci, porta nunc. Laoreet augue ut gravida tincidunt nulla etiam.
              Aliquam senectus arcu aliquam, cursus mauris. Nulla viverra tincidunt morbi sagittis augue ut malesuada.
            </p>
          </article>
        </section>
      </div>
